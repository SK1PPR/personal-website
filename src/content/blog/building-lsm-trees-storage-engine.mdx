...
I have started building a storage engine in Rust. It now has a name too: [`pocket-lsm`](https://crates.io/crates/pocket-lsm), published as an experimental `0.1.0` crate with the source on [GitHub](https://github.com/SK1PPR/pocket-lsm).
